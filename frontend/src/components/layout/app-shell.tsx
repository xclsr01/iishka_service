...
export function AppShell({
  ...
  return (
    <div className="h-[100dvh] overflow-hidden bg-background text-foreground">
      <div className="mx-auto flex h-[100dvh] w-full max-w-md overflow-x-hidden flex-col px-4 pb-4 pt-3 md:max-w-4xl md:px-6 lg:max-w-5xl lg:px-8">
        ...
        <main className={cn('relative z-10 flex min-h-0 flex-1 flex-col gap-4 overflow-x-hidden', className)}>
          {children}
        </main>
      </div>
    </div>
