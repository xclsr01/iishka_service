...
export function HomePage({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-x-hidden overflow-y-auto pb-5">
        ...
        <Card className="overflow-hidden border-primary/20 bg-[linear-gradient(135deg,rgba(12,18,35,0.96),rgba(15,25,48,0.88))] px-3 py-2.5 sm:px-4 sm:py-2.5">
          ...
          <div className="relative flex items-start justify-between gap-3">
            <div className="min-w-0 space-y-1.5">
              <Badge className="border-primary/30 bg-primary/10 px-3 py-1 text-[11px] text-primary">
                {t('neuralAccess')}
              </Badge>
              <h1 className="font-display text-xl font-bold leading-tight text-white sm:text-2xl">
                {t('heroTitle')}
              </h1>
              <p className="max-w-[32rem] text-xs leading-5 text-muted-foreground sm:text-sm">
            ...
            <div className="flex flex-col items-end gap-2">
              ...
              <div className="hidden rounded-[16px] border border-primary/25 bg-primary/10 p-2.5 shadow-soft sm:block">
        ...
        <Card
          className={
            subscription.hasAccess
              ? 'border-primary/25 bg-[linear-gradient(135deg,rgba(10,23,39,0.92),rgba(12,18,34,0.82))] px-4 py-2.5'
              : 'border-accent/20 bg-[linear-gradient(135deg,rgba(32,20,16,0.92),rgba(17,14,28,0.86))] px-4 py-2.5'
          }
        >
          <div className="grid gap-2.5">
            <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-x-3 gap-y-2">
              ...
              <div className="justify-self-end">
                <div className="min-w-[70px] rounded-[14px] border border-primary/35 bg-primary px-3 py-2 text-left text-primary-foreground shadow-soft">
            ...
            <div className="flex flex-row flex-nowrap gap-2">
              ...
              <Button
                type="button"
                variant="ghost"
                className="h-9 min-w-0 flex-1 border-destructive/25 bg-destructive/10 px-4 text-destructive hover:bg-destructive/15"
                disabled={
                  isActivatingSubscription || isUnsubscribingSubscription
                }
      ...
      <section className="flex min-h-0 flex-1 flex-col gap-2">
        ...
        <div className="-mx-4 min-h-0 flex-1 overflow-x-auto overflow-y-auto px-4 pb-8 lg:mx-0 lg:px-0">
          <div className="flex h-full snap-x gap-3 pb-4 lg:grid lg:h-auto lg:min-h-full lg:grid-cols-2 lg:auto-rows-min lg:gap-3 xl:grid-cols-3">
