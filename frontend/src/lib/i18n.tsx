...
const translations: Record<Locale, Record<string, TranslationValue>> = {
  ru: {
    ...
    errorSessionExpired: 'Сессия истекла. Откройте Mini App заново и попробуйте ещё раз.',
    errorSubscriptionRequired: 'Проверьте подписку, чтобы продолжить действие.',
    errorProviderBusy: 'ИИ-провайдер сейчас перегружен. Попробуйте через минуту.',
    errorProviderTimeout: 'ИИ-провайдер слишком долго отвечал. Попробуйте ещё раз.',
    errorProviderFailed: 'ИИ-провайдер не смог выполнить запрос. Попробуйте ещё раз.',
    errorNetwork: 'Не удалось подключиться к сети. Проверьте соединение и попробуйте ещё раз.',
    errorFileTooLarge: 'Файл слишком большой для загрузки.',
    errorUnsupportedFile: 'Этот тип файла не поддерживается.',
    errorNotFound: 'Этот объект больше недоступен.',
    languageRu: 'RU',
    languageEn: 'EN',
